    ...
    <Modal show={show} onHide={handleClose}>
      ...
      <Sidebar collapsed={iscollapsed}  className='h-100 '>
        <Menu>
          ...
          <MenuItem data-aos-delay="400" data-aos="fade-right"  className={`${pathname === '/dashboard/users' ? 'active' : null} link`} component={<Link to='/dashboard/users' />} icon={<Users size={'25px'} />}>Users</MenuItem>
